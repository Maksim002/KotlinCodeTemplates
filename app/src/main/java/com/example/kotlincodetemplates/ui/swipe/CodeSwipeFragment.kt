...
import kotlinx.android.synthetic.main.fragment_code_swipe.*

class CodeSwipeFragment : BaseFragment() {
    var url = "https://guides.codepath.com/android/implementing-pull-to-refresh-guide"
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_code_swipe, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        db.collection("swipe_view").addSnapshotListener { value, error ->
            error?.message
            val result = value!!.documents[0].toObject(ModelElements::class.java)
            val sendPicture = try {
                requireArguments().getString("swipe_view")
            } catch (e: Exception) {
                ""
            }
            when (sendPicture) {

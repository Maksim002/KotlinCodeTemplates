...
import kotlinx.android.synthetic.main.fragment_code_toast.*

class CodeToastFragment : BaseFragment() {
    var url = "https://guides.codepath.com/android/Displaying-Toasts"
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_code_toast, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        db.collection("code_toast").addSnapshotListener { value, error ->
            error?.message
            val result = value!!.documents[0].toObject(ModelElements::class.java)
            val sendPicture = try {
                requireArguments().getString("code_toast")
            } catch (e: Exception) {
                ""
            }
            when (sendPicture) {

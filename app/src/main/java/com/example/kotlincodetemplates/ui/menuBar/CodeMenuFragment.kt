...
import kotlinx.android.synthetic.main.fragment_code_menu.*

class CodeMenuFragment : BaseFragment() {
    var url = "https://guides.codepath.com/android/menus-and-popups"
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_code_menu, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        db.collection("menu_view").addSnapshotListener { value, error ->
            error?.message
            val result = value!!.documents[0].toObject(ModelElements::class.java)
            val sendPicture = try {
                requireArguments().getString("menu_view")
            } catch (e: Exception) {
                ""
            }
            when (sendPicture) {

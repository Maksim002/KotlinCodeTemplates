...
import kotlinx.android.synthetic.main.fragment_code_recycler.*

class CodeRecyclerFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_code_recycler, container, false)
    }

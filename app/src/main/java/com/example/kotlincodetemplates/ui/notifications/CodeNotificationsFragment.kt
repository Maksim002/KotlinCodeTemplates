...
import kotlinx.android.synthetic.main.fragment_code_notifications.*

class CodeNotificationsFragment : BaseFragment() {
    var url = "https://guides.codepath.com/android/push-messaging"
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_code_notifications, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        db.collection("push_natification").addSnapshotListener { value, error ->
            error?.message
            val result = value!!.documents[0].toObject(ModelElements::class.java)
            val sendPicture = try {
                requireArguments().getString("push_natification")
            } catch (e: Exception) {
                ""
            }
            when (sendPicture) {
